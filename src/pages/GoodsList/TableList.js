...
const CreateForm = Form.create()(props => {
  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="货号">
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="型号">
        ...
        })(<Input placeholder="请输入型号（衣服大小）" />)}
      </FormItem>
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="颜色">
        {form.getFieldDecorator('color')(<Input placeholder="请输入颜色" />)}
      </FormItem>
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="成分">
        {form.getFieldDecorator('type', {
          rules: [{ required: true, message: '请输入成分！' }],
        })(<Input placeholder="请输入成分" />)}
      </FormItem>
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="售价">
        {form.getFieldDecorator('price', {
          rules: [{ required: true, message: '请输入售价！' }],
        })(<InputNumber placeholder="请输入售价" />)}
      </FormItem>
...
class TableList extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Fragment>
          <a onClick={() => this.handleUpdateModalVisible(true, record)}>打印</a>
  ...
  handleSearch = e => {
    ...
    form.validateFields((pagination, err, fieldsValue) => {
      if (err) return;
